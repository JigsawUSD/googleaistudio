...
export const WhatsAppButton: React.FC = () => {
  const phoneNumber = '5519988937976';
  ...
  return (
    ...
    >
      ...
      {/* Label text that expands smoothly on hover or stays clear */}
      <span className="hidden md:inline-block font-sans font-bold text-xs tracking-wider uppercase pr-1">
        Fale Conosco
      </span>
    </motion.a>
  );
